...
//       <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
//         <div className="bg-white p-8 rounded-xl shadow-md text-center max-w-sm w-full">
//           <div className="text-red-500 mb-2 mx-auto h-12 w-12 flex items-center justify-center bg-red-50 rounded-full">❌</div>
//           <h1 className="text-xl font-bold text-gray-900">Bill Not Found</h1>
//         </div>
//       </div>
//     );
...
//       <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
//         <div className="bg-white p-8 rounded-xl shadow-md text-center max-w-sm w-full">
//           <div className="text-orange-500 mb-4 mx-auto h-12 w-12 flex items-center justify-center bg-orange-50 rounded-full">⚠️</div>
//           <h1 className="text-2xl font-bold text-gray-800">Link Expired</h1>
//         </div>
//       </div>
//     );
...
//     if (m.includes('qr') || m.includes('upi')) return 'UPI / QR';
...
//         <div className="p-6 relative">
//           <div className="text-center mb-8 border-b border-dashed border-gray-200 pb-6">
//             <div className="inline-flex items-center justify-center h-12 w-12 rounded-full bg-indigo-50 text-[#5a4fcf] mb-3 text-xl">🧾</div>
//             <h2 className="text-2xl font-bold text-gray-900">Payment Receipt</h2>
//             <p className="text-sm text-gray-500 mt-1">Order #{sale.billId}</p>
//             <p className="text-xs text-gray-400 mt-1">{new Date(sale.createdAt).toLocaleString()}</p>
//           </div>
...
//                     </div>
//                     <span className="font-semibold text-gray-900 whitespace-nowrap">{formatMoney(item.price * item.quantity)}</span>
//                   </div>
//                 ))
//               ) : (
...
//             <div className="flex justify-between items-center">
//               <span className="text-lg font-bold text-gray-800">Total Paid</span>
//               <span className="text-2xl font-bold text-[#5a4fcf]">{formatMoney(sale.amount)}</span>
//             </div>
//           </div>
...
//           </div>
//         </div>
//         <div className="h-4 w-full bg-gray-100" style={{ backgroundImage: 'linear-gradient(45deg, #ffffff 25%, transparent 25%), linear-gradient(-45deg, #ffffff 25%, transparent 25%)', backgroundSize: '20px 20px', backgroundPosition: '0 0' }}></div>
//       </div>
//     </div>
//   );
// }