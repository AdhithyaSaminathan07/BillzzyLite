  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="format-detection" content="telephone=no" />
        <meta name="msapplication-TileColor" content="#0ea5e9" />
        <meta name="msapplication-TileImage" content="/assets/pwa-app.png" />
        <meta name="msapplication-config" content="none" />
        
        {/* Apple Touch Icons */}
        <link rel="apple-touch-icon" sizes="180x180" href="/assets/pwa-app.png" />
        <link rel="apple-touch-icon" sizes="152x152" href="/assets/pwa-app.png" />
        <link rel="apple-touch-icon" sizes="120x120" href="/assets/pwa-app.png" />
        <link rel="apple-touch-icon" sizes="76x76" href="/assets/pwa-app.png" />
        
        {/* Standard Icons */}
        <link rel="icon" type="image/png" sizes="192x192" href="/assets/pwa-app.png" />
        <link rel="icon" type="image/png" sizes="512x512" href="/assets/pwa-app.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="/assets/pwa-app.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/assets/pwa-app.png" />
