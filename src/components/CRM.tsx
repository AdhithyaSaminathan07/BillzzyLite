    ...
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <button 
          ...
          className="w-full sm:w-auto bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors text-sm font-medium flex items-center justify-center gap-2 disabled:opacity-50"
        >
      ...
      <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
        <div className="flex flex-col gap-4">
          ...
          {/* Date Filter & Reset - Stacked for Mobile, Row for Desktop */}
      ...
      {loading ? (
        ...
        <>
          {/* Mobile View - Flex Cards (Clean Layout) */}
          <div className="sm:hidden space-y-3">
            {filteredCustomers.map((customer) => (
              <div key={customer._id} className="bg-white border border-gray-200 rounded-lg p-3 shadow-sm flex items-center gap-3">
                ...
                {/* Main Info (Flex-1 takes available space) */}
                ...
                {/* Date & Action (Fixed width on right) */}
