...
//             type="submit"
//             disabled={loading}
//             className="w-full rounded-md bg-blue-600 px-4 py-2 text-base font-semibold text-white shadow-sm transition-colors duration-200 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-blue-400"
//           >
