...
//           - items-start: Ensures boxes don't stretch weirdly when one is open and one is closed
//         */}
...
//               onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#4a3fbf'}
//               onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#5a4fcf'}
//             >
...
//             {/* Profit Dropdown Content - Expands naturally */}
//             {showProfit && (
...
//             {/* CRM Dropdown Content - Expands naturally */}
//             {showCRM && (
//               <div className="p-6 bg-gray-50 border-t border-gray-100">
//                 <CRMComponent />
//               </div>
...
//             More report sections coming soon
//           </p>
//         </div>
//       </div>
//     </div>
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-gray-100 text-center">
          ...
          <form onSubmit={handlePinSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 px-4 rounded-xl text-white font-medium shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 mt-6"
              style={{ backgroundColor: '#5a4fcf' }}
            >
